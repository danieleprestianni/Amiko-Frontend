...
public class BLEExplorerFrame extends javax.swing.JFrame implements BGAPIListener {
    ...
    private void initComponents() {
        ...
        jButtonBLED112Conn.setText("Connect BLED112");
    ...
    private void jButtonBLED112ConnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonBLED112ConnActionPerformed
        ...
        if (port != null) {
            try {
                ...
                // enable the BLE disconnect button
    ...
    private void jButtonConnectActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonConnectActionPerformed
        ...
        //AMIKO bgapi.send_gap_set_directed_connectable_mode(BDAddr.fromString(d.getAddress()), 1);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
    	...
    	//AMIKO: documentation page 38
    	//GOTO1

    	//bgapi.send_attclient_attribute_write(connection, 0xE, new byte[]{0x3f,0x30} );//OK
        
        //bgapi.send_attclient_attribute_write(connection, 0x0C, new byte[]{0x01,0x00});    	
        bgapi.send_attclient_write_command(connection, 0xC, new byte[]{0x01,0x00});
        
        
        //AMIKO Send prepare write request to remote host for queueing.
    	//Queued writes are executed or canceled with attclient_execute_write command.
    	//AMIKO bgapi.send_attclient_prepare_write(connection, 0xE, 0, new byte[]{0x57});
    	
        //bgapi.send_attclient_read_by_handle(connection, 0xE);
        //bgapi.send_attributes_write(0xB, 0, new byte[]{0x55});
        //bgapi.send_attclient_attribute_write(0, 0xE, new byte[]{0x50, 0x51} );
        //bgapi.send_attclient_read_by_handle(connection, 0xB);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
    	...
    	//AMIKO Send prepare write request to remote host for queueing.
    	//Queued writes are executed or canceled with attclient_execute_write command.
//    	bgapi.send_attclient_prepare_write(connection, 0xE, 0, new byte[]{0x57});
    	
    	System.out.println("write attribute");
    	
        //bgapi.send_attclient_attribute_write(connection, 0xE,new byte[]{0x59} );
    	bgapi.send_attclient_attribute_write(connection, 0xE,new byte[]{(byte)0xAA,0x00});
	...
	public void receive_attributes_read(int handle, int offset, int result, byte[] value) {
		...
		System.out.println("2 handle=" + handle + " offset=" + offset + " result=" + result + " value=" + this.bytesToString(value));
	}
	...
	public void receive_connection_disconnected(int connection, int reason) {
		//AMIKO da usare per gestire l'evento di disconnessione inattesa del device
		System.out.println("receive_connection_disconnected");
	}
	...
	public void receive_attclient_read_by_group_type(int connection, int result) {
		// Not Connected (0x0186):Connection handle passed is to command is not a valid handle
		System.out.println("6");
		System.out.println("6 connection=" + connection + " result=" + result);
		if(result==0x0186){
	...
	public void receive_attclient_read_by_handle(int connection, int result) {
		...
		System.out.println("9 response read by handle result=" + result);
		if(result==0x0181){
			System.out.println("9 Device is in wrong state to receive command");
		}
	}
	public void receive_attclient_attribute_write(int connection, int result) {
		System.out.println("10");
		System.out.println("10 connection=" + connection + " result=" + result);
		//bgapi.send_attclient_read_by_handle(connection, 0xB);
		//bgapi.send_attributes_read(0xB, 0);
	}
	public void receive_attclient_write_command(int connection, int result) {
		System.out.println("11");
		System.out.println("11 response read by handle result=" + result);
	}
	...
	public void receive_attclient_read_long(int connection, int result) {
		...
		System.out.println("12 connection=" + connection + " result=" + result);
	}
	public void receive_attclient_prepare_write(int connection, int result) {
		System.out.println("20");
		System.out.println("20 connection=" + connection + " result=" + result);
		bgapi.send_attclient_execute_write(connection, 1);// commit queue
	}
	...
	public void receive_attclient_read_multiple(int connection, int result) {
		...
		System.out.println("13 connection=" + connection + " result=" + result);
	}
	public void receive_attclient_indicated(int connection, int attrhandle) {
		System.out.println("14");
		System.out.println("14 connection=" + connection + " attrhandle=" + attrhandle);
	}
	//AMIKO: documentation page 66
	//AMIKO: This event is produced for example after the attclient_attribute_write is used by the GATT client, to indicate if the
	//GATT server has written the intended attribute
	public void receive_attclient_procedure_completed(int connection, int result, int chrhandle) {
            ...
            if (result != 0) {
            	...
            	System.out.println("connection=" + connection + " result=" + result + " chrhandle=" + chrhandle);
            }
        }
	...
	public void receive_attclient_read_multiple_response(int connection, byte[] handles) {
		...
		System.out.println("15 connection=" + connection + " handles=" + handles);
	}
	...
	public void receive_gap_connect_direct(int result, int connection_handle) {
		//AMIKO our implementation
		//result: procedure was succesfully started 0
		//result: An error occurred Non-zero
		//connection_handle: Connection handle that is reserved for new connection
		System.out.println("result=" + result + " connection handle=" + connection_handle);
		if(result==0){
			System.out.println("BLE device connected, connection handle is:" + connection_handle);
		}else{
			System.out.println("BLE device NOT connected, result= " + result);			
		}
	}
	...
	public void receive_gap_set_directed_connectable_mode(int result) {
		// Device in Wrong State (0x0181): Device is in wrong state to receive command
		System.out.println("K");

		System.out.println(result);
		if(result==0x0181){
			System.out.println("Device is in wrong state to receive command");
		}
	}
